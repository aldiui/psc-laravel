            ...
            if ($request->input("mode") == "datatable") {
                return DataTables::of($barangs)
                    ->addColumn('aksi', function ($barang) {
                        $editButton = '<button class="btn btn-sm btn-warning mr-1" onclick="getSelectEdit(); getModal(\'editModal\', \'/admin/barang/' . $barang->id . '\', [\'uuid\',\'kategori_id\',\'unit_id\',\'nama\', \'deskripsi\', \'qty\', \'image\'])"><i class="fas fa-edit mr-1"></i>Edit</button>';
