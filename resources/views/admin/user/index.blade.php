        ...
        $(document).ready(function() {
            ...
            $("#updateData").submit(function (e) {
                ...
                const successCallback = function (response) {
                    ...
                    $(".img-navbar").css("background-image", `url('/storage/img/karyawan/${response.data.image}')`);    
                };

                const errorCallback = function (error) {
                    setButtonLoadingState("#updateData .btn.btn-success", false);
                    handleValidationErrors(error, "updateData", ["nama", "email",  "jabatan", "no_hp", "image"]);
                };
            ...
            $("#updatePassword").submit(function (e) {
                ...
                e.preventDefault();
                const url = `{{ route('admin.user.password')}}`;
                const data = new FormData(this);
